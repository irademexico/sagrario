...
<body>
	...
	<table width="180" border="0">
			<tr>
				...
				<td><input type="text" name="paterno" maxlength="30" size="30" value="<?php echo $paterno;?>"></td>
				<td><input type="text" name="materno" maxlength="30" size="30" value='<?php echo $materno;?>'></td>
			</tr>
		</table>
<table style="background: #ccff66;">
		<tr> <td>Hij:</td>
			<td><input type="text" name="hijo-a"  maxlength="1" size="1" placeholder="O/A"></td>
			<td>de: <input type="text" name="padre" maxlength="50" size="50"></td>
			<td> y de <input type="text" name="madre" maxlength="50" size="50"></td>
		</tr>
		</table>

<table style="background: #ccff66;">
	<tr>
		<td>Nacio el: <input type="date" name="fechanac" size="10"></td>
</table>
<table><tr>
	<?php
